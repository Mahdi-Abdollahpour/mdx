...
def sim_ber(mc_fun,
    ...
    return ber, bler, tf.cast(bit_errors, tf.float64), tf.cast(block_errors, tf.float64), tf.cast(nb_bits, tf.float64),  tf.cast(nb_blocks, tf.float64)
